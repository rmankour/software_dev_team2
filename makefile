objects = run_tests test_file_geneticAlgo.o
CXXFLAGS= -Wall

run_tests: test_file_geneticAlgo.o
	g++ -o run_tests test_file_geneticAlgo.o googletest-release-1.10.0/build/lib/libgtest.a googletest-release-1.10.0/build/lib/libgtest_main.a
	./run_tests
