...
## Classe permettant d'executer le programme de traitement des données avec les paramètres fixés par l'utilisateur : le nombre d'enfants par génération, le nombre de générations et l'adresse du fichier .CSV contenant le tableau de données
...
## MODIFIER CETTE LIGNE EN METTANT LES ARGUMENTS DE VOTRE CHOIX AVEC DANS L'ORDRE : le nombre d'enfants par génération, le nombre de générations et l'adresse du fichier .CSV contenant le tableau de données
